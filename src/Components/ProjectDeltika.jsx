  ...
  return (
    <div className="projectFrame">
      <div data-aos="fade-right" className="projectInfo">
        ...
        <div>
          <p>
            Deltika uses explainable AI analytics that translates your data into
            proactive insights. Currently focused on US real estate market.
          </p>
          <p>Site includes complex database queries, dynamic map and more.</p>
          <p className="note">
            <b>Note:</b> Site it targeted for desktop to prioritize speed and
            not showing well on small screens.
          </p>
        </div>
      ...
      <div data-aos="fade-left" className="projectView">
        <iframe
          width="100%"
          height="315"
          src="https://www.youtube.com/embed/cXqHgyv9TFc?rel=0&mute=1&showinfo=0&autoplay=1&loop=1"
          frameBorder="0"
          allowFullScreen
        ></iframe>
      </div>
